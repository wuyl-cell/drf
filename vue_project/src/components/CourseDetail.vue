            ...
            <div class="course-info">
                ...
                <div class="wrap-right">
                    ...
                    <p class="data">{{ course.students }}人在学&nbsp;&nbsp;&nbsp;&nbsp;课程总时长：{{
                            course.lessons
                        }}课时/{{ course.lessons }}小时&nbsp;&nbsp;&nbsp;&nbsp;难度：{{ course.level_model }}</p>
                    ...
                    <div class="buy">
                        ...
                        <div class="add-cart" @click="add_cart"><img  src="/static/image/cart-yellow.svg" alt="">
                            加入购物车
                        </div>
                    </div>
                </div>
                ...
                <div class="course-tab-list">
                    ...
                    <div class="tab-item" v-if="tabIndex==2">
                        <div class="tab-item-title">
                            ...
                            <p class="chapter-length">共{{ chapter_len }}章 {{ course.lessons }}个课时</p>
                        </div>
                        <div class="chapter-item" v-for="(item, index1) in chapter_list">
                            <p class="chapter-title"><img src="/static/image/1.svg" alt="">第{{
                                    index1 + 1
                                }}章·{{ item.name }}</p>
                            <ul class="lesson-list">
                                <li class="lesson-item" v-for="(lesson, index2) in item.coursesections">
                                    <p class="name"><span class="index">{{ index1 + 1 }}-{{ index2 + 1 }}</span>
                                        {{ lesson.name }}<span class="free" v-show="lesson.free_trail">免费</span>
                                    </p>
                                    <p class="time">07:30 <img src="/static/image/chapter-player.svg"></p>
                                    <button class="try" v-show="lesson.free_trail">立即试学</button>
                                </li>
                            </ul>
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        ...
        get_chapter_lesson(){
            this.$axios({
                url: this.$settings.HOST + 'course/course_lessons/',
                method: "get",
                params: {
                ...
                res => {
                    ...
                    this.chapter_len = res.data.length
                }
            ).catch(
